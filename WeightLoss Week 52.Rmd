...
DF <- na.omit(DF)
DF.t <- DF[-c(36,37,56)]
DF.t <- DF.t[c(10,20,23,26,29,32,35,38,41,44,47,50,53)]
...
DF <- na.omit(DF)
DF.t <- DF[-c(36,37,56)]
DF.t <- DF.t[c(11,20,23,26,29,32,35,38,41,44,47,50,53)]
DF.t = scale(DF.t, center = TRUE, scale = TRUE)
DF.t <- as.data.frame(DF.t)
...
DF <- na.omit(DF)
DF.t <- DF[-c(36,37,56)]
DF.t <- DF.t[c(12,20,23,26,29,32,35,38,41,44,47,50,53)]
DF.t = scale(DF.t, center = TRUE, scale = TRUE)
DF.t <- as.data.frame(DF.t)
...
DF <- na.omit(DF)
DF.t <- DF[-c(36,37,56)]
DF.t <- DF.t[c(17,20,23,26,29,32,35,38,41,44,47,50,53)]
DF.t = scale(DF.t, center = TRUE, scale = TRUE)
DF.t <- as.data.frame(DF.t)
...
DF <- na.omit(DF)
DF.t <- DF[-c(36,37,56)]
DF.t <- DF.t[c(14,20,23,26,29,32,35,38,41,44,47,50,53)]
DF.t = scale(DF.t, center = TRUE, scale = TRUE)
DF.t <- as.data.frame(DF.t)
